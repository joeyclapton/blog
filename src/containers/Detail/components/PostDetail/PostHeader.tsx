...
const PostHeader: React.FC<Props> = ({ data }) => {
  return (
    <>
      ...
      {data.type[0] !== "Paper" && (
        <nav className="mt-6 text-gray-900 dark:text-gray-400">
          ...
          {data.thumbnail && (
            <div className="relative w-full pb-[66%] lg:pb-[50%] bg-gray-200 dark:bg-slate-900	 mb-7 rounded-3xl overflow-hidden">
              <Image
                src={data.thumbnail}
